...
<head>
	...
	<title>Sign In Form For Paraskar's Workshop</title>
...
<body>
			...
			<div class="container">
				<div class="signin-content">
					<div class="signin-image">
						<figure>
							<img src="images/signin-imagee.jpg" alt="sing up image">
						</figure>
	...
	<script type="text/javascript">
		...
		if(status == "failed"){
			swal("Sorry","<font color =red size=18> Wrong Email or Password! <br>", "error");
		}
